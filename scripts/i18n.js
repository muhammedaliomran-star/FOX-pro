...
const STRINGS = {
  ar: {
    ...
    trial_card_title: '🎁 تجربة مجانية',
    trial_card_desc: 'احصل على مفتاح تجريبي فوري لمدة 30 دقيقة لاختبار الإضافة فوراً!',
    btn_get_trial: 'توليد مفتاح تجريبي (30 دقيقة)',
    generating_trial: 'جاري توليد السيريال...',
    trial_generated_ok: 'تم توليد مفتاح التجربة وتفعيله بنجاح! 🎉',
  ...
  en: {
    ...
    trial_card_title: '🎁 Free Trial',
    trial_card_desc: 'Get an instant 30-minute trial key to test the extension now!',
    btn_get_trial: 'Generate Trial Key (30 min)',
    generating_trial: 'Generating Key...',
    trial_generated_ok: 'Trial key generated & activated! 🎉',
